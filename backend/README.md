...
## Project Structure
    ...
    ├── testapiautocatalog_110151  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_110151`
...
2. Clone this repo and `cd testapiautocatalog_110151`
